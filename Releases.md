...
- **Setup > Telemetry preserves unmanaged and native sensor slots on save (`app/pages/setup/telemetry/page.lua`, `docs/pages/setup/telemetry.md`) (fixes #277)**:
  ...
  - `onSave` accounts for unmanaged slots when verifying against the 40-slot limit (`#selected + unmanagedCount <= 40`).
